<!DOCTYPE html>
<html class="loaded" lang="en" data-textdirection="ltr" style="--vh: 3.3000000000000003px;"><!-- BEGIN: Head-->

<head>
@include('pages.masterVuexy.css')
</head>
...
<body class="pace-done horizontal-layout horizontal-menu navbar-floating footer-static menu-expanded" data-open="hover"
    ...
    <!-- BEGIN: Header-->
    @include('pages.masterVuexy.navbar')
    ...
    <ul class="main-search-list-defaultlist-other-list d-none">
        <li class="auto-suggestion justify-content-between"><a
                ...
                <div class="d-flex justify-content-start"><svg xmlns="http://www.w3.org/2000/svg" width="14"
                        ...
                        class="feather feather-alert-circle me-75">
    ...
    <div class="horizontal-menu-wrapper">
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl"
           ...
           @include('pages.masterVuexy.menu')
        </div>
    </div>
    <!-- END: Main Menu-->
    ...
    <!-- BEGIN: Footer-->
   @include('pages.masterVuexy.footer')
    <!-- END: Footer-->


    <!-- BEGIN: Vendor JS-->
   @include('pages.masterVuexy.js')
</body><!-- END: Body-->
